...
$images2016Path = mkdir "$ASDKpath\images\2016" -Force
$images2019Path = mkdir "$ASDKpath\images\2019" -Force
...
try {
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/ConfigASDK.ps1"
    ...
    # Ubuntu Server AZPKG
    $row = $table.NewRow(); $row.Uri = "https://github.com/$gitHubAccount/azurestack/raw/$branch/deployment/packages/Ubuntu/Canonical.UbuntuServer1804LTS-ARM.1.0.0.azpkg"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/scripts/Convert-WindowsImage.ps1"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/packages/Aliases/aliases.json"
    ...
    $row = $table.NewRow(); $row.Uri = "https://github.com/$gitHubAccount/azurestack/raw/$branch/deployment/packages/WindowsServer/Microsoft.WindowsServer2016Datacenter-ARM.1.0.0.azpkg"
    ...
    $row = $table.NewRow(); $row.Uri = "https://github.com/$gitHubAccount/azurestack/raw/$branch/deployment/packages/WindowsServer/Microsoft.WindowsServer2016DatacenterServerCore-ARM.1.0.0.azpkg"
    ...
    # MYSQL AZPKG
    $row = $table.NewRow(); $row.Uri = "https://github.com/$gitHubAccount/azurestack/raw/$branch/deployment/packages/MySQL/ASDK.MySQL.1.0.0.azpkg"
    $row.filename = "ASDK.MySQL.1.0.0.azpkg"; $row.path = "$packagePath"; $row.productName = "MySQL Marketplace Package"; $Table.Rows.Add($row)
    # SQL AZPKG
    $row = $table.NewRow(); $row.Uri = "https://github.com/$gitHubAccount/azurestack/raw/$branch/deployment/packages/MSSQL/ASDK.MSSQL.1.0.0.azpkg"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/scripts/install_MySQL_Offline.sh"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/scripts/install_MSSQL_Offline.sh"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/templates/MySQLHosting/azuredeploy.json"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/templates/SQLHosting/azuredeploy.json"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/templates/FileServer/azuredeploy.json"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/templates/FileServer/scripts/OnStartAzureVirtualMachineFileServer.ps1"
    ...
    $row = $table.NewRow(); $row.Uri = "https://github.com/$gitHubAccount/azurestack/raw/$branch/deployment/templates/FileServer/scripts/fileserver.cr.zip"
    ...
    $row = $table.NewRow(); $row.Uri = "https://raw.githubusercontent.com/$gitHubAccount/azurestack/$branch/deployment/appservice/AppServiceDeploymentSettings.json"
